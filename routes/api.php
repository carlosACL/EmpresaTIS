...
Route::post('guardarCambiosGrupoEmpresa', [EditarGEController::class, 'GuardarCambiosGrupoEmpresa'])->name('rgep');
//Route::post('guardarCambiosGrupoEmpresa', [RegistroGEController::class, 'RegistrarGrupoEmpresa'])->name('rgep');
